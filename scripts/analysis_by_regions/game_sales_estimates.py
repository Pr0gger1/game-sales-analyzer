...
def get_game_sale_estimates(df: DataFrame, export_as_img: bool = True):
...
def build_sales_distribution_by_critic_score_plot(df: PDataFrame, export_as_img: bool = True):
...
def build_heatmap_correlation_matrix(df: PDataFrame, sales_columns: list[str], export_as_img: bool = True):
    plt.figure(figsize=(10, 6))
