...
def get_game_sales_by_regions(df: DataFrame, game_name: str, export_as_img: bool = True) -> DataFrame:
    title: str = cd["title"]
...
def visualize_game_sales_by_regions(df: DataFrame, game_name: str, export_as_img: bool = True):
